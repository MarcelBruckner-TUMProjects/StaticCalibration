...
cv::Mat static_calibration::evaluation::addText(const cv::Mat &frame, const std::string &text, double fontSize, int x, int y,
										 cv::Scalar color) {
...
template<typename T>
std::vector<cv::Mat> static_calibration::evaluation::concatenate(const std::initializer_list<T> &frames, int padding, cv::Size
size) {
...
template cv::Mat static_calibration::evaluation::vconcat(const std::initializer_list<cv::Mat> &, int padding, cv::Size size);
...
template cv::Mat static_calibration::evaluation::hconcat(const std::initializer_list<cv::Mat> &, int padding, cv::Size size);
...
void static_calibration::evaluation::ImageSetup::addRuntimeToFinalFrame(const std::string &text, long milliseconds, int x,
																 int y) {
